...
- **Phase 4 tracker:** [docs/phase4/security/findings-tracker.md](../../phase4/security/findings-tracker.md); zero open Critical / High for governance scope at closure.
- **Phase 3 tracker (continuity):** [docs/phase3/security/findings-tracker.md](../../phase3/security/findings-tracker.md); zero open Critical / High.
