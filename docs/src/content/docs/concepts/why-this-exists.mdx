...
<CardGrid>
	...
	<LinkCard href="/guides/governance-how-to-use/" title="How to use" description="Wire the live registry, run pre-flight checks, and walk updates." />
	<LinkCard href="/concepts/overview/" title="Overview" description="What each component does in a typical integration." />
</CardGrid>
