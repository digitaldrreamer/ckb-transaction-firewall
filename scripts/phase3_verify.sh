...
- Test log: \`notes/internal/phase3_artifacts/$(basename "$TEST_LOG")\`
- Cycle log: \`notes/internal/phase3_artifacts/$(basename "$CYCLE_LOG")\`
- Guard log: \`notes/internal/phase3_artifacts/$(basename "$GUARD_LOG")\`
