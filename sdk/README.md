...
Threat model and extended narrative: [ABOUT.md](../ABOUT.md). Architecture and CKB rationale: [docs/architecture.md](../docs/architecture.md). Quick start: [README.md](../README.md).
